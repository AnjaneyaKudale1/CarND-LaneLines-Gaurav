...
{\color{incolor}In [{\color{incolor}1}]:} \PY{c+c1}{\PYZsh{}importing some useful packages}
        ...
        \PY{k+kn}{import} \PY{n+nn}{moviepy}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}2}]:} <matplotlib.image.AxesImage at 0x1d6516a13c8>
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{k+kn}{import} \PY{n+nn}{math}
        ...
        \PY{c+c1}{\PYZsh{}         for x1,y1,x2,y2 in line:}
        \PY{c+c1}{\PYZsh{}             cv2.line(img, (x1, y1), (x2, y2), color, thickness)}
                
            \PY{n}{m\PYZus{}l} \PY{o}{=} \PY{p}{[}\PY{p}{]}
            \PY{n}{c\PYZus{}l} \PY{o}{=} \PY{p}{[}\PY{p}{]}
            \PY{n}{m\PYZus{}r} \PY{o}{=} \PY{p}{[}\PY{p}{]}
            \PY{n}{c\PYZus{}r} \PY{o}{=} \PY{p}{[}\PY{p}{]}
            \PY{n}{imshape} \PY{o}{=} \PY{n}{img}\PY{o}{.}\PY{n}{shape}
            ...
            \PY{k}{for} \PY{n}{line} \PY{o+ow}{in} \PY{n}{lines}\PY{p}{:}
                \PY{k}{for} \PY{n}{x1}\PY{p}{,}\PY{n}{y1}\PY{p}{,}\PY{n}{x2}\PY{p}{,}\PY{n}{y2} \PY{o+ow}{in} \PY{n}{line}\PY{p}{:}
                    \PY{n}{m} \PY{o}{=} \PY{p}{(}\PY{p}{(}\PY{n}{y2}\PY{o}{\PYZhy{}}\PY{n}{y1}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{n}{x2}\PY{o}{\PYZhy{}}\PY{n}{x1}\PY{p}{)}\PY{p}{)}
                    \PY{k}{if} \PY{p}{(}\PY{p}{(}\PY{n}{m}\PY{o}{\PYZlt{}}\PY{l+m+mf}{0.8} \PY{o+ow}{and} \PY{n}{m}\PY{o}{\PYZgt{}}\PY{l+m+mf}{0.5}\PY{p}{)}\PY{o+ow}{or}\PY{p}{(}\PY{n}{m}\PY{o}{\PYZgt{}}\PY{o}{\PYZhy{}}\PY{l+m+mf}{0.8} \PY{o+ow}{and} \PY{n}{m}\PY{o}{\PYZlt{}}\PY{o}{\PYZhy{}}\PY{l+m+mf}{0.5}\PY{p}{)}\PY{p}{)}\PY{p}{:}
                        \PY{k}{if} \PY{p}{(}\PY{n}{x1} \PY{o}{\PYZlt{}} \PY{p}{(}\PY{n}{img}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)} \PY{o+ow}{and} \PY{n}{x2} \PY{o}{\PYZlt{}} \PY{p}{(}\PY{n}{img}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}\PY{p}{:}
                            \PY{n}{m\PYZus{}l}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{m}\PY{p}{)}
                            \PY{n}{c\PYZus{}l}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{y1}\PY{o}{\PYZhy{}}\PY{n}{m}\PY{o}{*}\PY{n}{x1}\PY{p}{)}
                            \PY{n}{c\PYZus{}l}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{y2}\PY{o}{\PYZhy{}}\PY{n}{m}\PY{o}{*}\PY{n}{x2}\PY{p}{)}
                        \PY{k}{else}\PY{p}{:}
                            \PY{n}{m\PYZus{}r}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{m}\PY{p}{)}
                            \PY{n}{c\PYZus{}r}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{y1}\PY{o}{\PYZhy{}}\PY{n}{m}\PY{o}{*}\PY{n}{x1}\PY{p}{)}
                            \PY{n}{c\PYZus{}r}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{y2}\PY{o}{\PYZhy{}}\PY{n}{m}\PY{o}{*}\PY{n}{x2}\PY{p}{)}
            \PY{k}{try}\PY{p}{:}
                \PY{n}{mavg\PYZus{}l} \PY{o}{=} \PY{n+nb}{sum}\PY{p}{(}\PY{n}{m\PYZus{}l}\PY{p}{)}\PY{o}{/}\PY{n+nb}{len}\PY{p}{(}\PY{n}{m\PYZus{}l}\PY{p}{)}
                \PY{n}{mavg\PYZus{}r} \PY{o}{=} \PY{n+nb}{sum}\PY{p}{(}\PY{n}{m\PYZus{}r}\PY{p}{)}\PY{o}{/}\PY{n+nb}{len}\PY{p}{(}\PY{n}{m\PYZus{}r}\PY{p}{)}
            
                \PY{n}{cavg\PYZus{}l} \PY{o}{=} \PY{n+nb}{sum}\PY{p}{(}\PY{n}{c\PYZus{}l}\PY{p}{)}\PY{o}{/}\PY{n+nb}{len}\PY{p}{(}\PY{n}{c\PYZus{}l}\PY{p}{)}
                \PY{n}{cavg\PYZus{}r} \PY{o}{=} \PY{n+nb}{sum}\PY{p}{(}\PY{n}{c\PYZus{}r}\PY{p}{)}\PY{o}{/}\PY{n+nb}{len}\PY{p}{(}\PY{n}{c\PYZus{}r}\PY{p}{)}
                
                \PY{n}{y1} \PY{o}{=} \PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
                \PY{n}{y4} \PY{o}{=} \PY{n}{y1}
                \PY{n}{y2} \PY{o}{=} \PY{l+m+mi}{330}
                \PY{n}{y3} \PY{o}{=} \PY{n}{y2}
            
                \PY{n}{x1} \PY{o}{=} \PY{p}{(}\PY{n}{y1}\PY{o}{\PYZhy{}}\PY{n}{cavg\PYZus{}l}\PY{p}{)}\PY{o}{/}\PY{n}{mavg\PYZus{}l}
                \PY{n}{x2} \PY{o}{=} \PY{p}{(}\PY{n}{y2}\PY{o}{\PYZhy{}}\PY{n}{cavg\PYZus{}l}\PY{p}{)}\PY{o}{/}\PY{n}{mavg\PYZus{}l}
            
                \PY{n}{x3} \PY{o}{=} \PY{p}{(}\PY{n}{y3}\PY{o}{\PYZhy{}}\PY{n}{cavg\PYZus{}r}\PY{p}{)}\PY{o}{/}\PY{n}{mavg\PYZus{}r}
                \PY{n}{x4} \PY{o}{=} \PY{p}{(}\PY{n}{y4}\PY{o}{\PYZhy{}}\PY{n}{cavg\PYZus{}r}\PY{p}{)}\PY{o}{/}\PY{n}{mavg\PYZus{}r}   
            
                \PY{n}{cv2}\PY{o}{.}\PY{n}{line}\PY{p}{(}\PY{n}{img}\PY{p}{,} \PY{p}{(}\PY{n+nb}{int}\PY{p}{(}\PY{n}{x1}\PY{p}{)}\PY{p}{,} \PY{n+nb}{int}\PY{p}{(}\PY{n}{y1}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{n+nb}{int}\PY{p}{(}\PY{n}{x2}\PY{p}{)}\PY{p}{,} \PY{n+nb}{int}\PY{p}{(}\PY{n}{y2}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{n}{color}\PY{p}{,} \PY{n}{thickness}\PY{p}{)}
                \PY{n}{cv2}\PY{o}{.}\PY{n}{line}\PY{p}{(}\PY{n}{img}\PY{p}{,} \PY{p}{(}\PY{n+nb}{int}\PY{p}{(}\PY{n}{x3}\PY{p}{)}\PY{p}{,} \PY{n+nb}{int}\PY{p}{(}\PY{n}{y3}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{n+nb}{int}\PY{p}{(}\PY{n}{x4}\PY{p}{)}\PY{p}{,} \PY{n+nb}{int}\PY{p}{(}\PY{n}{y4}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{n}{color}\PY{p}{,} \PY{n}{thickness}\PY{p}{)}
            
            \PY{k}{except} \PY{n+ne}{ZeroDivisionError}\PY{p}{:}
          \PY{c+c1}{\PYZsh{}  except ValueError:}
        
                \PY{c+c1}{\PYZsh{} Don\PYZsq{}t error when a line cannot be drawn}
                \PY{k}{pass}
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{k+kn}{import} \PY{n+nn}{os}
        \PY{n}{dirlist} \PY{o}{=} \PY{n}{os}\PY{o}{.}\PY{n}{listdir}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{test\PYZus{}images/}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{n}{op\PYZus{}path} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{test\PYZus{}images\PYZus{}output}\PY{l+s+s2}{\PYZdq{}}
        \PY{n+nb}{print}\PY{p}{(}\PY{n}{dirlist}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
['challengevideotrial.JPG', 'challengevideotrial\_2.JPG', 'challengevideotrial\_3.JPG', 'challengevideotrial\_4.JPG', 'solidWhiteCurve.jpg', 'solidWhiteRight.jpg', 'solidYellowCurve.jpg', 'solidYellowCurve2.jpg', 'solidYellowLeft.jpg', 'whiteCarLaneSwitch.jpg']
...
thresholds as well as the Hough lines parameters.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{k}{def} \PY{n+nf}{lane\PYZus{}lines}\PY{p}{(}\PY{n}{image}\PY{p}{)}\PY{p}{:}
            \PY{n}{imshape} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{shape}
            
            \PY{c+c1}{\PYZsh{}Gray scale the image}
            \PY{n}{gray} \PY{o}{=} \PY{n}{grayscale}\PY{p}{(}\PY{n}{image}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{}Gaussian Smoothing}
            \PY{n}{blur\PYZus{}gray} \PY{o}{=} \PY{n}{gaussian\PYZus{}blur}\PY{p}{(}\PY{n}{gray}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{}Canny Edge Detection}
            \PY{n}{edges} \PY{o}{=} \PY{n}{canny}\PY{p}{(}\PY{n}{blur\PYZus{}gray}\PY{p}{,}\PY{l+m+mi}{50}\PY{p}{,}\PY{l+m+mi}{150}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{}Masked Edges}
            \PY{n}{vertices} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{,}\PY{p}{(}\PY{l+m+mi}{450}\PY{p}{,}\PY{l+m+mi}{320}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{l+m+mi}{500}\PY{p}{,}\PY{l+m+mi}{320}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{]}\PY{p}{]}\PY{p}{,}\PY{n}{dtype}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{int32}\PY{p}{)}
            \PY{n}{masked\PYZus{}edges} \PY{o}{=} \PY{n}{region\PYZus{}of\PYZus{}interest}\PY{p}{(}\PY{n}{edges}\PY{p}{,}\PY{n}{vertices}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{}Hough Transform \PYZhy{} To identify lines in the ROI}
            \PY{n}{rho} \PY{o}{=} \PY{l+m+mi}{2}
            \PY{n}{theta} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{180}
            \PY{n}{threshold} \PY{o}{=} \PY{l+m+mi}{25}
            \PY{n}{min\PYZus{}line\PYZus{}len} \PY{o}{=} \PY{l+m+mi}{20}
            \PY{n}{max\PYZus{}line\PYZus{}gap} \PY{o}{=} \PY{l+m+mi}{5}
            \PY{n}{line\PYZus{}image} \PY{o}{=} \PY{n}{hough\PYZus{}lines}\PY{p}{(}\PY{n}{masked\PYZus{}edges}\PY{p}{,} \PY{n}{rho}\PY{p}{,} \PY{n}{theta}\PY{p}{,} \PY{n}{threshold}\PY{p}{,} \PY{n}{min\PYZus{}line\PYZus{}len}\PY{p}{,} \PY{n}{max\PYZus{}line\PYZus{}gap}\PY{p}{)}
            
            \PY{n}{weight\PYZus{}image}\PY{o}{=} \PY{n}{weighted\PYZus{}img}\PY{p}{(}\PY{n}{line\PYZus{}image}\PY{p}{,}\PY{n}{image}\PY{p}{)}
            
            \PY{k}{return} \PY{n}{weight\PYZus{}image}\PY{p}{,}\PY{n}{masked\PYZus{}edges}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{c+c1}{\PYZsh{} TODO: Build your pipeline that will draw lane lines on the test\PYZus{}images}
        \PY{c+c1}{\PYZsh{} then save them to the test\PYZus{}images\PYZus{}output directory.}
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n}{dirlist}\PY{p}{:}
            \PY{n}{image} \PY{o}{=} \PY{n}{mpimg}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{n}{os}\PY{o}{.}\PY{n}{path}\PY{o}{.}\PY{n}{join}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{test\PYZus{}images/}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{i}\PY{p}{)}\PY{p}{)}   
            \PY{n}{weight\PYZus{}image}\PY{p}{,} \PY{n}{masked\PYZus{}edges} \PY{o}{=} \PY{n}{lane\PYZus{}lines}\PY{p}{(}\PY{n}{image}\PY{p}{)}
            \PY{n}{mpimg}\PY{o}{.}\PY{n}{imsave}\PY{p}{(}\PY{n}{os}\PY{o}{.}\PY{n}{path}\PY{o}{.}\PY{n}{join}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{test\PYZus{}images\PYZus{}output/}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{i}\PY{p}{)}\PY{p}{,}\PY{n}{weight\PYZus{}image}\PY{p}{)}
            \PY{n}{mpimg}\PY{o}{.}\PY{n}{imsave}\PY{p}{(}\PY{n}{os}\PY{o}{.}\PY{n}{path}\PY{o}{.}\PY{n}{join}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{test\PYZus{}images\PYZus{}output/line}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{i}\PY{p}{)}\PY{p}{,}\PY{n}{masked\PYZus{}edges}\PY{p}{)}
\end{Verbatim}
...
forum post} for more troubleshooting tips across operating systems.}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{\PYZsh{} Import everything needed to edit/save/watch video clips}
        \PY{k+kn}{from} \PY{n+nn}{moviepy}\PY{n+nn}{.}\PY{n+nn}{editor} \PY{k}{import} \PY{n}{VideoFileClip}
        \PY{k+kn}{from} \PY{n+nn}{IPython}\PY{n+nn}{.}\PY{n+nn}{display} \PY{k}{import} \PY{n}{HTML}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{k}{def} \PY{n+nf}{process\PYZus{}image}\PY{p}{(}\PY{n}{image}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{result}\PY{p}{,}\PY{n}{abc} \PY{o}{=} \PY{n}{lane\PYZus{}lines}\PY{p}{(}\PY{n}{image}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{n}{white\PYZus{}output} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}videos\PYZus{}output/solidWhiteRight.mp4}\PY{l+s+s1}{\PYZsq{}}
...
[MoviePy] Writing video test\_videos\_output/solidWhiteRight.mp4
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
100\%|███████████████████████████████████████████████████████████████████████████████▋| 221/222 [00:06<00:00, 34.24it/s]
...
tricky!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{yellow\PYZus{}output} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}videos\PYZus{}output/solidYellowLeft.mp4}\PY{l+s+s1}{\PYZsq{}}
         \PY{c+c1}{\PYZsh{}\PYZsh{} To speed up the testing process you may want to try your pipeline on a shorter subclip of the video}
         \PY{c+c1}{\PYZsh{}\PYZsh{} To do so add .subclip(start\PYZus{}second,end\PYZus{}second) to the end of the line below}
         \PY{c+c1}{\PYZsh{}\PYZsh{} Where start\PYZus{}second and end\PYZus{}second are integer values representing the start and end of the subclip}
         \PY{c+c1}{\PYZsh{}\PYZsh{} You may also uncomment the following line for a subclip of the first 5 seconds}
...
[MoviePy] Writing video test\_videos\_output/solidYellowLeft.mp4
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
100\%|███████████████████████████████████████████████████████████████████████████████▉| 681/682 [00:19<00:00, 34.11it/s]
...
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{challenge\PYZus{}output} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}videos\PYZus{}output/challenge.mp4}\PY{l+s+s1}{\PYZsq{}}
        ...
        \PY{n}{clip3} \PY{o}{=} \PY{n}{VideoFileClip}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}videos/challenge.mp4}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{o}{.}\PY{n}{subclip}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}
